...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of use" updated="2 July 2026">
      <LegalSection title="1. What Aurora Homes is">
        <p>
          Aurora Homes is an independent marketplace and AI marketing
          platform for property listings. Aurora Homes acts as a pure
      ...
      <LegalSection title="3. What Aurora Homes does not provide">
        <p>
          In this version of the product, Aurora Homes does not provide
          ...
          Aurora Homes, under agreements you are responsible for reviewing.
        </p>
      </LegalSection>
      ...
      <LegalSection title="6. User conduct">
        <p>
          ...
          must not use Aurora Homes to post fraudulent, misleading, or
      ...
      <LegalSection title="7. Limitation of liability">
        <p>
          Aurora Homes is provided on an &ldquo;as is&rdquo; basis during this
          early stage of the product. To the maximum extent permitted by
          law, Aurora Homes is not liable for losses arising from
      ...
      <LegalSection title="8. Changes">
        <p>
          ...
          Aurora Homes after changes constitutes acceptance of the updated
          terms.
        </p>
      </LegalSection>
    </LegalPage>
