...
export const metadata: Metadata = {
  ...
  description:
    "Upload photos and Zouza prepares a professional sales exposé, buyer FAQ, and verification badge — sell directly, without the agency process.",
};

const features = [
  { icon: Upload, title: "Upload photos", text: "Bring the photos you already have. No professional shoot required." },
  { icon: FileText, title: "Professional sales exposé", text: "Zouza writes a buyer-ready description, lifestyle and location copy." },
        ...
        <div className="container-page">
          <Reveal>
            ...
            <p className="mt-4 max-w-xl text-lg text-navy-600">
              Upload photos. Zouza prepares your sales listing — description,
        ...
        <div className="container-page max-w-2xl">
          <Reveal>
            ...
            <p className="mt-4 leading-relaxed text-navy-600">
              Zouza.ai is a marketing and marketplace platform — we do not
